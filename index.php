    ...
    <div class="row" id="hero">
        ...
        <div class="name show-for-medium-up">
            <div class="medium-6 large-6 columns">
                <img src="images/AuMNsccolor.gif"/ >
            </div>
        </div>
        ...
        <div class="small-12 medium-6 large-6 columns info">
            ...
            <div style="padding: 0px 20px 0px 20px;">
                ...
                <p style="text-align:justify;"><strong style="color:rgba(100,100,100,1.0);">If you find a dead or injured bird, you can make an important contribution to <a href="http://mn.audubon.org/conservation-efforts" target="blank">Audubon Minnesota's conservation work</a> by submitting the information through D-Bird.</p>
                ...
                <div class="small-12 medium-12 large-12 columns">
                    <div class="panel">
                        ...
                        <h4>1. Select Location *</h4>
                        	...
                        	<div class="show-for-small-only" style="font-size: 12px;">Use this button to report a bird <strong>in your current location</strong> - to log a different location or see a map, <a href="http://d-bird.org/mn/mobile.php"><strong>click here</strong></a></div>
                                ...
                                <div class="textInput">
                                    <select name="species" id="entry_212797529" aria-label="Species  " aria-required="true" required="">
                                        ...
                                        <?php
                                            ...
                                            $query = "SELECT species_value, species_display from Minnesota";
    ...
    <script>
        ...
        var geosearchControl;
            ...
            $(document).ready(function () {
                ...
                map = L.map('map', {scrollWheelZoom: false}).setView([46.108989, -94.551000], 7);

                geosearchControl = new L.Control.GeoSearch({
                    provider: new L.GeoSearch.Provider.Google({
                        componentRestrictions: {"administrativeArea":"MN"}
                    }),
                    position: 'topcenter'
                }).addTo(map);
